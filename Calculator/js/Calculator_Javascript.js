...
const Calculator = {
    //this will dis[lay 0 on the calc screen
    Display_Value: '0',
    //this will hold the first operand for any expression, we set it to null for now
    First_Operand: null,
    //this checks wethor the second operand has been inputed by the user
    Wait_Second_Operand: false,
    //this will hold the operator, we set it to null for now
    operator: null,
};

//this modiefies values each time a button is clicked on
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //Here we add a fixed ammount of numbers after th decimal
...
//This function updates the calulator screen with the contents of Display_Value
